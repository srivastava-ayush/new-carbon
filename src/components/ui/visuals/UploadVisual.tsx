export default function UploadVisual() {
  return (
    <svg viewBox="0 0 480 360" preserveAspectRatio="xMidYMid slice" className="h-full w-full" role="img" aria-label="Uploading data visual">
      ...
      <g>
        <rect x="120" y="104" width="112" height="136" rx="12" fill="#ffffff" stroke="#188f8b" strokeWidth="1.5" strokeDasharray="5 5" strokeOpacity="0.4" />
        <circle cx="176" cy="148" r="26" fill="#eef8f7" stroke="#188f8b" strokeWidth="1.5" />
        <path d="M176 134v22M166 144l10-10 10 10" stroke="#188f8b" strokeWidth="1.6" fill="none" strokeLinecap="round" strokeLinejoin="round" />
        <text x="176" y="202" textAnchor="middle" fontSize="10" fontWeight="600" letterSpacing="0.12em" fill="#188f8b">
          DROP FILES
        </text>
      ...
      <g>
        ...
        <text x="348" y="118" textAnchor="end" fontSize="9" fontWeight="600" fill="#188f8b">100%</text>
        <rect x="260" y="128" width="88" height="4" rx="2" fill="#e4e4e7" />
        <rect x="260" y="128" width="88" height="4" rx="2" fill="#188f8b" />
        ...
        <text x="348" y="166" textAnchor="end" fontSize="9" fontWeight="600" fill="#188f8b">64%</text>
        <rect x="260" y="176" width="88" height="4" rx="2" fill="#e4e4e7" />
        <rect x="260" y="176" width="56" height="4" rx="2" fill="#188f8b" />
        ...
        <text x="348" y="214" textAnchor="end" fontSize="9" fontWeight="600" fill="#188f8b">38%</text>
        <rect x="260" y="224" width="88" height="4" rx="2" fill="#e4e4e7" />
        <rect x="260" y="224" width="34" height="4" rx="2" fill="#188f8b" />
      </g>

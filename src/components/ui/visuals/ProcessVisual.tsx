  ...
  return (
    <svg viewBox="0 0 480 360" preserveAspectRatio="xMidYMid slice" className="h-full w-full" role="img" aria-label="Processing data visual">
      ...
      <g>
        ...
        <rect x="134" y="136" width="20" height="26" rx="4" fill="none" stroke="#188f8b" strokeWidth="1.5" />
        <path d="M144 146v8M140 150h8" stroke="#188f8b" strokeWidth="1.5" strokeLinecap="round" />
      ...
      <g stroke="#188f8b" strokeWidth="1.5" strokeLinecap="round" opacity="0.45">
      ...
      <g>
        ...
        <circle cx="240" cy="172" r="23" fill="#eef8f7" stroke="#188f8b" strokeWidth="1.5" />
        <circle className="vc-pulse" cx="240" cy="172" r="5" fill="#43b0a9" />
      ...
      <g>
        ...
        <rect x="298" y="136" width="42" height="7" rx="3.5" fill="#188f8b" fillOpacity="0.85" />
        ...
        <rect x="298" y="196" width="18" height="8" rx="4" fill="#188f8b" />
      ...
      <g>
        ...
        <line x1="120" y1="300" x2="270" y2="300" stroke="#188f8b" strokeWidth="1.5" />
        <g className="vc-track">
          <circle cx="120" cy="300" r="5" fill="#ffffff" stroke="#188f8b" strokeWidth="1.5" />
        </g>
        <text x="360" y="304" textAnchor="end" fontSize="10" fontWeight="600" letterSpacing="0.1em" fill="#188f8b">
          68%
        </text>
      </g>
    </svg>

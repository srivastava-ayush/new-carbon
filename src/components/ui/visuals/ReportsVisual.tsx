  ...
  return (
    <svg viewBox="0 0 480 360" preserveAspectRatio="xMidYMid slice" className="h-full w-full" role="img" aria-label="Audit ready report visual">
      ...
      <g>
        ...
        />
        <circle className="vc-pulse" cx="216" cy="170" r="3.5" fill="#43b0a9" />
        <text x="216" y="160" textAnchor="end" fontSize="9" fontWeight="600" letterSpacing="0.1em" fill="#188f8b">
          −42%
        </text>
      </g>
      ...
      <g>
        ...
        <rect x="262" y="102" width="72" height="9" rx="2" fill="#188f8b" fillOpacity="0.85" />
        <rect x="262" y="126" width="40" height="5" rx="2.5" fill="#000000" fillOpacity="0.1" />
        <rect x="318" y="126" width="30" height="5" rx="2.5" fill="#188f8b" fillOpacity="0.35" />
        <rect x="262" y="140" width="34" height="5" rx="2.5" fill="#000000" fillOpacity="0.1" />
        <rect x="318" y="140" width="30" height="5" rx="2.5" fill="#188f8b" fillOpacity="0.35" />
        <rect x="262" y="154" width="44" height="5" rx="2.5" fill="#000000" fillOpacity="0.1" />
        <rect x="318" y="154" width="30" height="5" rx="2.5" fill="#188f8b" fillOpacity="0.35" />
        <line x1="262" y1="172" x2="344" y2="172" stroke="#f0f0f0" strokeWidth="1.5" />
        <rect x="262" y="182" width="82" height="20" rx="4" fill="#0d4f4b" />
        <text x="303" y="195" textAnchor="middle" fontSize="8" fontWeight="600" letterSpacing="0.12em" fill="#ffffff">
          12,480 TCO₂E
        </text>
        <rect x="262" y="210" width="82" height="26" rx="6" fill="#eef8f7" stroke="#188f8b" strokeWidth="1.5" />
        <circle cx="276" cy="223" r="7" fill="none" stroke="#188f8b" strokeWidth="1.5" />
        <path d="M273 223l2.5 2.5 4.5-5" stroke="#188f8b" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round" />
        <text x="290" y="227" fontSize="6" fontWeight="600" letterSpacing="0.12em" fill="#188f8b">
          AUDIT READY
        </text>
      </g>
      ...
      <g>
        ...
        <circle className="vc-pulse" cx="138" cy="291" r="4" fill="#43b0a9" />

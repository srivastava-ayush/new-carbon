    ...
    <div className="flex flex-col gap-[16px]">
          ...
          return (
            <motion.button
              ...
              className={`relative flex flex-col rounded-[14px] border p-[16px] text-left transition-colors duration-200 ${
                active ? "border-[#188f8b]/40 bg-[#f2faf9]" : "border-black/[0.06] bg-white hover:border-black/[0.12]"
              }`}
            >
              <div className="flex items-center justify-between">
                <span
                  className={`flex h-[28px] w-[28px] items-center justify-center rounded-[8px] transition-colors duration-200 ${
                    active ? "bg-[#188f8b] text-white" : "bg-[#eef8f7] text-[#188f8b]"
                  }`}
                >
                ...
                <span
                  className={`flex items-center gap-[2px] rounded-full px-[6px] py-[2px] text-[10.5px] font-semibold tabular-nums ${
                    g.delta < 0 ? "bg-[#eef8f7] text-[#188f8b]" : "bg-[#fef2f2] text-[#dc2626]"
                  }`}
                >
      ...
      <div className="grid grid-cols-1 gap-[16px] lg:grid-cols-3">
        <Section
          ...
          delay={0.15}
          action={
            <span className="rounded-full bg-[#eef8f7] px-[8px] py-[2px] text-[11px] font-semibold text-[#188f8b]">
        ...
        >
          <VerticalBars
            data={FOOTPRINT_GROUPS.map((g: any, i: number) => ({
              ...
              value: g.value,
              color: i === selected ? "#188f8b" : i % 2 === 0 ? "#43b0a9" : "#3faea7",
            }))}
            delay={0.2}
            suffix=""
            height={230}
        ...
        <Section title="Group share" subtitle="Share of total footprint" delay={0.2}>
          <Donut
            segments={FOOTPRINT_GROUPS.map((g: any, i: number) => ({
              ...
              value: g.value,
              share: g.share,
              color: i === 0 ? "#188f8b" : i === 1 ? "#43b0a9" : i === 2 ? "#3faea7" : i === 3 ? "#a7dcd6" : "#b5e2de",
            }))}
          ...
          <div className="flex flex-col gap-[12px]">
            {(() => {
              ...
              return (
                ...
                >
                  <span className="flex h-[30px] w-[30px] shrink-0 items-center justify-center rounded-[8px] bg-[#eef8f7] text-[#188f8b]">
                    {Icon && <Icon size={15} />}
                  </span>

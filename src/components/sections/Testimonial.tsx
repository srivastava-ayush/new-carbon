      ...
      <Reveal>
        <figure className="mx-auto max-w-[760px] text-center">
          <svg
            viewBox="0 0 24 24"
            fill="currentColor"
            className="mx-auto h-[36px] w-[36px] text-[#188f8b]/30"
            aria-hidden="true"
          >
          ...
          <figcaption className="mt-[32px] flex items-center justify-center gap-[14px]">
            <span className="flex h-[44px] w-[44px] items-center justify-center rounded-full bg-[#188f8b]/10 font-display text-[18px] text-[#188f8b]">
              M
            </span>
